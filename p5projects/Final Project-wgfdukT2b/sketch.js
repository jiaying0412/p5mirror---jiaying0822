//credit to Yan for helping me out with my code,
//codingtrain videos
//David Hill's illustration I used as the background for the game
//present icons downloaded from flaticons.com
var timeleft = 180; //timer set for 2 min
var startTime = 0;
var currentTime = 0;
...
function draw() {
  image(winterBG,0,0,width,height);
  textFont(myFont);
  textSize(25);
  ...
  if (currentTime < timeleft) {
    if (score == 8) {
      ...
      text("of the hidden presents!",770,240);
      textSize(18);
      text("scavenger hunt illustration done by David Hill",770,280);
