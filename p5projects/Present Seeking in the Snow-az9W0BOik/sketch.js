...
function header(){
  cane0 = createImg('cane.png');
  cane0.position(300,22);
  cane0.size(20,20);
  gMan0 = createImg('gMan.png');
  gMan0.position(420,22);
  gMan0.size(20,20);
  globe0 = createImg('globe.png');
  globe0.position(540,22);
  globe0.size(20,20);
  gloves0 = createImg('gloves.png');
  gloves0.position(660,22);
  gloves0.size(20,20);
  hotChoc0 = createImg('hotChoc.png');
  hotChoc0.position(780,22);
  hotChoc0.size(20,20);
  skate0 = createImg('skate.png');
  skate0.position(900,22);
  skate0.size(20,20);
  stocking0 = createImg('stocking.png');
  stocking0.position(1020,22);
  stocking0.size(20,20);
  ted0 = createImg('ted.png');
